...
const Navbar = () => {
  return (
    <div>
        <header className="text-gray-400 bg-gray-900 body-font mb-[3rem]">
  <div className="container mx-auto flex flex-wrap  flex-row md:flex-row items-center justify-between">
